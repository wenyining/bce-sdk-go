...
func getURLForEsg() string {
	return URI_PREFIX + REQUEST_ENI_URL
}

func getURLForEsgId(esgId string) string {
	return getURLForEsg() + "/" + esgId
}

func getURLForEsgRuleId(esgRuleId string) string {
	return getURLForEsg() + "/rule/" + esgRuleId
}
