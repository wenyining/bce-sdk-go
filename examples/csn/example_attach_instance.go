...
func AttachInstance() {
	...
	request := &csn.AttachInstanceRequest{
	...
	if err = client.AttachInstance("Your csnId", request, util.NewUUID()); err != nil {
		fmt.Printf("Failed to attach instance, err: %v.\n", err)
		return
	}
	fmt.Println("Successfully attached instance.")
}
