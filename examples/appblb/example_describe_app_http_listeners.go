...
func DescribeAppHTTPListeners() {
	...
	result, err := blbClient.DescribeAppHTTPListeners(BlbID, DescribeAppListenerArgs)
	if err != nil {
		fmt.Println("describe app http listeners error: ", err)
		return
	}
